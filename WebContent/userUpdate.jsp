	...
	<form role="form" action='/JsonTest/BackDeleteUsers' method='post'>
		<div class="form-group">
			<div class="div1 container">
				<div class="row">
					...
					<label>用户姓名</label>
						<input name="userUpdateName" type="text" class="form-control"
							value=<%out.println(request.getParameter("userName"));%>
							placeholder=<%out.println(request.getParameter("userName"));%>>
					</div>
				</div>
			</div>
		</div>
		<div class="form-group">
			<div class="div1 container">
				...
				<div class="row">
					<div class="col-md-3 col-md-push-2">
						<label>用户密码</label> <input name="userUpdatePassword" type="text"
							class="form-control"
							placeholder=<%out.println(request.getParameter("userPassword"));%>>
					</div>
				</div>
				<div class="row">
					<div class="col-md-3 col-md-push-2">
