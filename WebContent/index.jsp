...
<div class="jumbotron">
	...
	<form role="form" action='/JsonTest/loginVerifyServlet' method='post'>
		...
		<div class="form-group">
			<div class="div1 container">
				...
				<div class="row">
					<div class="col-md-3 col-md-push-2">
						<label>密码</label> <input name="AdminPassword" type="text"
							class="form-control"
							placeholder="密码">
					</div>
				</div>
				<div class="row">
					<div class="col-md-3 col-md-push-2">
						<button type="submit" class="btn btn-info update-btn-1">登录</button>
					</div>
				</div>
			</div>
